...
void __fastcall TForm1::Otwrz1Click(TObject *Sender)
{
        ...
        {
        ShowMessage("B³ad otwarcia pliku!");
        }
        }
}
//---------------------------------------------------------------------------
...
{
        if(Application->MessageBox("Czy na pewno zakonczyc program?", "PotwierdŸ", MB_YESNO | MB_ICONQUESTION) == IDYES)
        {
...
{
      if(Application->MessageBox("Czy na pewno zakonczyc program?", "PotwierdŸ", MB_YESNO | MB_ICONQUESTION) == IDNO)
        {
        Action=caNone;
        }
...
void __fastcall TForm1::WytnijxCtrlX1Click(TObject *Sender)
{
        tresc->CutToClipboard();        
}
//---------------------------------------------------------------------------

void __fastcall TForm1::CopiujCtrlC1Click(TObject *Sender)
{
...
{
        ShellExecute(NULL,"open","http://onet.pl//", NULL, NULL, SW_SHOWNORMAL);
}
//---------------------------------------------------------------------------
